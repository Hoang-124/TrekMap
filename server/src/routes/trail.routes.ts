...
import { getTrails, getNearbyTrails, getTrailById, getGuides, createReview, getTrailReviews } from '../controllers/trail.controller.js';
...
router.get('/weather/:trailId', routeCache(120), getWeatherByTrailId);
